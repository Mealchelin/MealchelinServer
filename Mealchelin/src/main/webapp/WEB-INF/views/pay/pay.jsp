        ...
        <section class="pay_Sections">
            ...
            <div class="pay_MainContent">
                ...
                <div class="pay_FirstContentArea">
                    <img src="../img/new_01.jpg" class="pay_menuPhoto">
                    <span class="pay_FirstMemu">
                        <span class="pay_FirstName">안동식 순살 찜닭 </span>
                        <p class="pay_subFirstName">마이 셰프</p>
                    </span>
                    <span class="pay_number">1개</span>
                    <span class="pay_paynumber">15,800원</span>
                </div>
                <div class="pay_FirstContentArea">
                    <img src="../img/new_02.jpg" class="pay_menuPhoto">
                    <span class="pay_FirstMemu">
                        <span class="pay_FirstName">기사 식당 돼지 불백(2-3인)</span>
                        <p class="pay_subFirstName">마이 셰프</p>
                    </span>
                    <span class="pay_number">1개</span>
                    <span class="pay_paynumber">14,900원</span>
                </div>
                <div class="pay_FirstContentArea">
                    <img src="../img/new_03.jpg" class="pay_menuPhoto">
                    <span class="pay_FirstMemu">
                        <span class="pay_FirstName">소고기뭇국</span>
                        <p class="pay_subFirstName">쿳킷</p>
                    </span>
                    <span class="pay_number">1개</span>
                    <span class="pay_paynumber">16,800원</span>
                </div>
                ...
                <div class="pay_SecondContentArea">
                    ...
                    <div class="pay_userInfo">
                        <div class="pay_Sender">
                            ...
                            <span class="pay_usernames">백성연</span>
                        </div>
                        <div class="pay_Sender">
                            <span class="pay_userPhone">연락처</span>
                            <span class="pay_userPhones">010-0000-0000</span>
                        </div>
                    </div>
                    <div class="pay_Sender">
                        <span class="pay_userEmail">이메일</span>
                        <span class="pay_userEmails">kh@naver.com
                            <p>
                                이메일을 통해 주문처리과정을 보내드립니다
                                <br>
                                정보변경은 맛슐랭>개인정보 수정 메뉴에서 가능합니다
                            </p>
                        </span>
                    </div>
                </div>
                ...
                <div class="pay_DeliveryRequestInfoArea">
                    <div class="pay_DeliveryRequestInfo">
                        ...
                        <input class="pay_DeliveryUserRequest" type="text" placeholder="예)문앞에놔주세요">
                ...
                <div class="pay_payResultArea">
                    <div class="pay_payResult">
                        ...
                        <span class="pay_payment">결제 금액</span>
                        <span class="pay_pay">47,500원</span>
                    </div>
                    <div class="pay_paymentInfo">
                        <span class="pay_Product">ㄴ 상품금액</span>
                        <span class="pay_payMoney">47,500원</span>
                    </div>
                    <div class="pay_paymentInfo">
                        <span class="pay_Delivery">ㄴ 배송비</span>
                        <span class="pay_pay">0원</span>
                    </div>
                    <div class="pay_finalResult">
                        <span class="pay_Delivery">최종 결제 금액</span>
                        <span class="pay_Finalpay">47,500원</span>
                    </div>
                ...
                <div class="pay_userInfoArea">
                    ...
                    <div class="pay_userInfotwo">
                        <span class="pay_userInfoCheckResult">위 내용을 확인 하였으며 결제에 동의합니다.</span>
                        <p class="pay_subInfo">※ 주문완료 상태일 경우에만 주문 취소가 가능하며, 상품 미배송 시 결제하신 수단으로 환불됩니다.</p>
                    </div>
                </div>
                        ...
                        <div class="memmodal_in2">
                            ...
                            <table>
                                ...
                                <tr class="pay_Listget">
                                    ...
                                    <td class="pay_day" rowspan="4">업무 목적 달성 후 파기 (단, 타 법령에 따라 법령에서 규정한 기간 동안 보존)
                                    </td>
                                </tr>
                                <tr class="pay_Listget">
                                    <td>주류 구매 관리 및 신고</td>
                            ...
                            <div class="pay_waring">
                                <p>
                                    서비스 제공을 위해서 필요한 개인정보입니다.동의를 해 주셔야 서비스를 이용하실 수 있으며, 동의하지 않으실 경우 서비스에 제한이 있을 수 있습니다.
                                </p>
                            </div>
                        </div>

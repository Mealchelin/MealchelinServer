    ...
    <jsp:include page="/WEB-INF/views/mypage/mypageHeaderBox.jsp"/>
        <section id="pay_sections">
            ...
            <div class="pay_mainContentTitle">
                <span>주문번호 216156146546</span>
                <span class="pay_OrderDetails">배송 또는 상품에 문제가 있나요? <a href="#">1:1문의 ></a></span>
            </div>
                    ...
                    <div class="pay_ProductInfo">
                        <table class="pay_table">
                            ...
                            <tr class="pay_ProductMenu">
                                <td>결제금액</td>
                                <td class="pay_subNameTwo">15,800원 <span>ㅣ</span> 1개</td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="pay_button">
                <input type="button" value="상품 다시 담기">
                <input type="button" value="상품 목록 페이지 이동">
            </div>
            ...
            <div class="pay_Deliverycheck">
                    <table>
                        ...
                        <tr class="pay_secondInfoLine">
                            <td>주문번호 : 216156146546</td>
                            <td>상품 준비중</td>
                        </tr>               
                        <tr class="pay_secondInfoLine">
                            <td> 우체국택배 : 661530154874 </td>
                            <td>배송중</td>
                        </tr>     
                        <tr class="pay_secondInfoLine">
                            <td> 우체국택배 : 661530154874 </td>
            ...
            <div class="pay_FirstContentArea">
                <div class="pay_FirstContent">
                    <span class="pay_FirstContentTitle">결제 정보</span>
                    <span></span>
                </div>
            ...
            <div class="pay_SecondContentArea">
                <div class="pay_SecondContent">
                    <span class="pay_secondContentTitle">주문정보</span>
                    <span></span>
                </div>
        ...
        <div class="pay_tridContentArea">
            <div class="pay_tridContent">
                <span class="pay_secondContentTitle">배송정보</span>
                <span></span>
            </div>
            <div class="pay_userInfo">

		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-4" style="font-weight: 600;">자주 묻는 질문</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
											...
											<c:if test="${not empty list}">
											    <c:forEach var="support" items="${list}">
											        <tr>
											            ...
											            <td><input type="checkbox" class="ad_qna_chk" name="ad_qna_chk" value="${support.rnum}"></td>
											            <td>${support.rnum}</td>
                            ...
                            <section id="cs-section3">
					            <div class="cs-paging">
						            <button onclick="location.href='${ path }/admin/post/adQnA?page=${ pageInfo.prevPage }'">&lt;</button>
							        <c:forEach var="current" begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }">
											<c:choose>
												...
												<c:otherwise>
													<button onclick="location.href='${ path }/admin/post/adQnA?page=${ current }'">${ current }</button>
												</c:otherwise>
											</c:choose>
									</c:forEach>
									<button onclick="location.href='${ path }/admin/post/adQnA?page=${ pageInfo.nextPage }'">&gt;</button>
					            </div>
					        </section>
						</div>
					</div>

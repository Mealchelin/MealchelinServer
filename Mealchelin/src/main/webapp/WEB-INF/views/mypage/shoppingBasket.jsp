        	...
        	<form action="" method="get">
	            ...
	            <div class="myAllBox">
	                    ...
	                    <table>
			            	...
			            	<c:if test="${ not empty list }">
		                        ...
		                        <tr class="mytr">
		                            ...
		                            <td class="mytd3"><a href="${ path }/product/view?no=${sbp.prdNo}"><div class="myProductName"> [${ sbp.brand }] ${ sbp.name } </div></a></td>
		                            <td class="mytd4">
		                                <div class="myCounter myCounter1">
		                                    <input  type ="hidden" class="hiddenNo"             value="${sbp.prdNo}" />
		                                    <input  type ="hidden" class="hiddenPrice"             value="${sbp.price}" />
		                                    <button type ="button" class="counter myCounter-minus" id="my-view-quantity-minus1">-</button>
		                                    <input  type ="number" class="myCounter-quantity"      id="my-view-quantity1"
		                                            value="${ sbp.quantity }" dir="rtl" min="1" max="99" readonly>
		                                    <button type ="button" class="counter myCounter-plus"  id="my-view-quantity-plus1">+</button>
		                                </div>
		                            </td>
		                            <td class="mytd5"><div class="myProductPrice" id="my-view-totalPrice1" > <fmt:formatNumber value="${ sbp.totalPrice }" pattern="###,###,###"/>원 </div></td>
		                            <td class="mytd6"><a class="deleteProduct"><img src="../img/all/x.png" alt="취소버튼"></a></td>
		                        </tr>
		                        </c:forEach>
	                        </c:if>
	                ...
	                <div class="myAllPriceDiv">
	                    <div class="myAllPriceText"><fmt:formatNumber value="${ sbp.payment }" pattern="###,###,###"/>총 상품금액</div>
	                    <div class="myAllPrice">원</div>
	                </div>
	            </div>

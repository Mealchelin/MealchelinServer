    ...
    $('.myInputBtn1').on('click', ()=>{
            ...
            oncomplete: function(data) {
                ...
                if(data.userSelectedType === 'R'){
                    ...
                    document.getElementById("myMemberAdress3").value = '';
                }

                // 우편번호와 주소 정보를 해당 필드에 넣는다.
                document.getElementById('myMemberAdress').value = data.zonecode;
                document.getElementById("myMemberAdress2").value = addr;
                // 커서를 상세주소 필드로 이동한다.
                document.getElementById("myMemberAdress3").focus();
            }
        }).open();
    })
